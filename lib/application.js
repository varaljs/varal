...
class Application extends Container {
    ...
    initServer() {
        ...
        this.viewPath = server.viewPath;
        this.staticPath = server.staticPath;
        this.servicePath = server.servicePath;
        this.controllerPath = server.controllerPath;
        this.rootPath = server.rootPath;
    ...
    e404() {
        ...
        if (typeof handler === 'function')
            ...
            this.error(new Error('404 Not Found'), {
                log: false,
                show: false,
                status: 404,
                title: 'Not Found',
    ...
    e405() {
        ...
        if (typeof handler === 'function')
            ...
            this.error(new Error('405 Method Not Allowed'), {
                log: false,
                show: false,
                status: 405,
    ...
    render(view, data) {
        data = data || {};
        data.$app = this;
        view = path.join(this.rootPath, this.viewPath, view + '.html');
    ...
    service(name) {
        ...
        const servicePath = path.join(this.rootPath, this.servicePath, file);
