    ...
    createNew: function () {
        ...
        router.getCallback = function (method, path, group, prefix, middleware) {
            ...
            for (i = 0; i < group.routesMap.length; i += 1) {
                ...
                if (prefix + helper.pathFormat(value.path) === path) {
                    path_match = true;
        ...
        function createGroup(options) {
            ...
            router.index += 1;
            group.add = function (method, path, callback, middleware) {
                middleware = middleware || [];
            ...
            group.get = function (path, callback, middleware) {
                group.add('GET', path, callback, middleware);
            };
            group.post = function (path, callback, middleware) {
                group.add('POST', path, callback, middleware);
            };
